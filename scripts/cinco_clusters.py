# -*- coding: utf-8 -*-
"""
GENERA EL MAPA K-MEANS (VERSIÓN k=5 FIJO)
        
Se elimina la lectura de 'k_optimo.txt' y se
            fuerza el número de clústeres a k=5.
"""
import matplotlib
matplotlib.use('Agg')
...
def generar_mapa_con_k5():
    print("==========================================================")
    print("Paso 2: Generando mapa de clasificación con k=5 (fijo)")
    print("==========================================================")
