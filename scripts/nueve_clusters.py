# -*- coding: utf-8 -*-
"""
GENERA EL MAPA K-MEANS (VERSIÓN k=9 FIJO)
        
Se elimina la lectura de 'k_optimo.txt' y se
            fuerza el número de clústeres a k=9.
"""
import matplotlib
matplotlib.use('Agg')
...
def generar_mapa_con_k9():
    print("==========================================================")
    print("Paso 2: Generando mapa de clasificación con k=9 (fijo)")
    print("==========================================================")
